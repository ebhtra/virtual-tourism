...
struct Constants {
    ...
    static let EXTRAS = "url_n"  //to get this size of photo url's returned from flickr
    static let SAFE_SEARCH = "1"
    static let DATA_FORMAT = "json"
    static let NO_JSON_CALLBACK = "1"
    static let BOUNDING_BOX_HALF_WIDTH = 0.05 //how big is the bbox for flickr search
